...
Subtracition = Button(cal, padx=21,pady=16, bd=8, fg="black", font=('arial', 20, 'bold'),
                      text="-", bg="powder blue", command=lambda: btnClick("-")).grid(row=2, column=3)
# ================================================================================================================
btn1 = Button(cal, padx=16, bd=8, fg="black", font=('arial', 20, 'bold'),
              text="1", bg="teal", command=lambda: btnClick(1)).grid(row=3, column=0)
...
btn3 = Button(cal, padx=16, bd=8, fg="black", font=('arial', 20, 'bold'),
              text="Pi", bg="pink", command=lambda: btnClick(3.14)).grid(row=5, column=1)

btn3 = Button(cal, padx=16, bd=8, fg="black", font=('arial', 20, 'bold'),
              text=".", bg="pink", command=lambda: btnClick(".")).grid(row=5, column=2)

btn3 = Button(cal, padx=16, bd=8, fg="black", font=('arial', 20, 'bold'),
              text="x2", bg="pink", command=lambda: btnClick("*2")).grid(row=5, column=3)
